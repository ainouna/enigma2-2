# Embedded file name: /usr/lib/enigma2/python/OPENDROID/OPD_panel.py
...
class PasswdScreen(Screen):
    ...
    def updatetext(self):
        message = _('You must set a root password in order to be able to use network services, such as FTP, telnet or ssh.')
