# Embedded file name: /usr/lib/enigma2/python/OPENDROID/CronManager.py
...
config.OPD_panel.cronmanager_runwhen = NoSave(ConfigSelection(default='Daily', choices=[('Hourly', _('Hourly')),
 ('Daily', _('Daily')),
 ('Weekly', _('Weekly')),
 ('Monthly', _('Monthly'))]))
config.OPD_panel.cronmanager_dayofweek = NoSave(ConfigSelection(default='Monday', choices=[('Monday', _('Monday')),
 ('Tuesday', _('Tuesday')),
...
class SetupCronConf(Screen, ConfigListScreen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = ActionMap(['WizardActions',
         ...
         'MenuActions'], {'red': self.checkentry,
         'back': self.close,
